...
import { CATALOG_DATABASE } from './catalogData';
...
export const BMW_M3_GENERATIONS_HIERARCHY: VehicleGenerationHierarchy[] = [
  {
    ...
    availableEngines: ['2.3L S14B23 (195-220 CV)', '2.5L S14B25 (238 CV)'],
    bodyStyles: ['Coupé 2 Porte', 'Cabriolet'],
    markets: ['Europa', 'Nord America', 'Giappone'],
    updateChronology: [
      { year: 1986, eventIt: 'Lancio sul mercato della versione base 2.3L (195/200 CV)', eventEn: 'Market launch of base 2.3L model (195/200 HP)' },
      { year: 1988, eventIt: 'Introduzione M3 Evolution I / II (220 CV, condotti aspirazione rivisti)', eventEn: 'Introduction of M3 Evolution I / II (220 HP)' },
      { year: 1990, eventIt: 'Lancio della Sport Evolution III (2.5L 238 CV, serie limitata a 600 pezzi)', eventEn: 'Launch of Sport Evolution III (2.5L 238 HP, 600 units limited series)' }
    ],
    heroImageUrl: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=1200&auto=format&fit=crop'
  },
  {
    ...
    availableEngines: ['3.0L S50B30 (286 CV)', '3.2L S50B32 (321 CV)'],
    bodyStyles: ['Coupé', 'Sedan (Berlina)', 'Cabriolet'],
    markets: ['Global'],
    updateChronology: [
      { year: 1992, eventIt: 'Lancio M3 Coupé 3.0L S50 (286 CV)', eventEn: 'Launch M3 Coupé 3.0L S50 (286 HP)' },
      ...
      { year: 1996, eventIt: 'Upgrade a 3.2L S50B32 (321 CV) e cambio a 6 marce', eventEn: 'Upgrade to 3.2L S50B32 (321 HP) and 6-speed manual' }
    ],
  ...
  },
  {
    ...
    availableEngines: ['3.2L S54B32 (343 CV)', '3.2L S54B32 HP CSL (360 CV)'],
    bodyStyles: ['Coupé', 'Cabriolet'],
    markets: ['Global'],
    updateChronology: [
      { year: 2000, eventIt: 'Presentazione M3 E46 Coupé (343 CV)', eventEn: 'Debut M3 E46 Coupé (343 HP)' },
      { year: 2003, eventIt: 'Lancio M3 CSL (-110 kg, tetto in carbonio, 360 CV, airbox in carbonio)', eventEn: 'Launch M3 CSL (-110 kg, carbon roof, 360 HP, carbon airbox)' },
  ...
  },
  {
    ...
    availableEngines: ['4.0L S65B40 V8 (420 CV)', '4.4L S65B44 V8 GTS (450 CV)'],
    bodyStyles: ['E92 Coupé', 'E90 Sedan', 'E93 Cabriolet'],
    markets: ['Global'],
    updateChronology: [
      { year: 2007, eventIt: 'Debutto M3 E92 Coupé V8 4.0L (420 CV)', eventEn: 'Debut M3 E92 Coupé V8 4.0L (420 HP)' },
      { year: 2010, eventIt: 'Presentazione M3 GTS 4.4L (450 CV, roll-bar, alettone fisso, 135 pezzi)', eventEn: 'M3 GTS 4.4L debut (450 HP, roll cage, fixed wing, 135 units)' }
    ],
  ...
  },
  {
    ...
    availableEngines: ['3.0L S55B30 BiTurbo (431 CV - 460 CV)'],
    bodyStyles: ['Sedan (Solo 4 porte, la Coupé diventa M4 F82)'],
    markets: ['Global'],
    updateChronology: [
      { year: 2014, eventIt: 'Lancio M3 F80 Sedan (431 CV)', eventEn: 'Launch M3 F80 Sedan (431 HP)' },
      { year: 2016, eventIt: 'Competition Package (450 CV)', eventEn: 'Competition Package (450 HP)' },
      { year: 2018, eventIt: 'M3 CS (460 CV, 1200 esemplari)', eventEn: 'M3 CS (460 HP, 1200 units)' }
    ],
  ...
  },
  {
    ...
    descriptionIt: 'Sesta generazione con il propulsore S58 fino a 550 CV, opzione M xDrive a trazione integrale disinseribile e prima variante Touring G81.',
    ...
    distinctiveFeaturesIt: ['Motore S58 BiTurbo fino a 550 CV', 'Trazione M xDrive commutabile in 2WD', 'Prima M3 Touring della storia (G81)'],
    distinctiveFeaturesEn: ['S58 BiTurbo up to 550 HP', 'M xDrive switchable to pure 2WD', 'First ever factory M3 Touring (G81)'],
    availableEngines: ['3.0L S58B30T0 (480 CV - 550 CV)'],
    bodyStyles: ['G80 Sedan', 'G81 Touring'],
    markets: ['Global'],
    updateChronology: [
      { year: 2020, eventIt: 'Debutto M3 G80 Sedan (480 CV / 510 CV Competition)', eventEn: 'Debut M3 G80 Sedan (480 HP / 510 HP Competition)' },
      { year: 2022, eventIt: 'Lancio M3 Touring G81', eventEn: 'Launch M3 Touring G81' },
      { year: 2023, eventIt: 'M3 CS G80 (550 CV, trazione M xDrive)', eventEn: 'M3 CS G80 (550 HP, M xDrive)' }
    ],
    heroImageUrl: 'https://images.unsplash.com/photo-1617814076367-b759c7d7e738?w=1200&auto=format&fit=crop'
  }
];
...
export function getVehicleFamilyNavigation(modelSlugOrId: string = 'bmw-m3'): VehicleFamilyNavigation {
  ...
  const foundInCatalog = CATALOG_DATABASE.find(v => v.slug === modelSlugOrId || v.id === modelSlugOrId);
...
export const MEDIA_ASSETS_SAMPLE: MediaAsset[] = [
  {
    ...
    caption_it: 'Prospetto storico delle sei generazioni BMW M3 dal 1986 ad oggi'
  },
  {
    id: 'img-m3-e30-ext',
    ...
    copyrightStatus: 'Editorial Rights Reserved',
    caption_it: 'BMW M3 E30 in tinta Brillantrot con ruote BBS a nido d’ape'
  },
  {
    ...
    copyrightStatus: 'Editorial Rights Reserved',
    caption_it: 'Vano motore 4 cilindri S14B25 2.5 Litri con pippe candela rosse Motorsport'
  }
];
...
export const PRODUCTION_RECORDS_SAMPLE: ProductionRecord[] = [
  ...
  },
  {
    ...
    source: 'BMW Motorsport Homologation Papers FIA A-5326',
    confidenceScore: 100,
    verificationStatus: 'verified'
  }
];
