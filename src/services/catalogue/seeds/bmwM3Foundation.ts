...
export const BMW_M3_FOUNDATION_SEED: CanonicalSeedBundle = {
  ...
  version: '1.2.0',
  description: 'First controlled, authoritative real-world canonical catalogue dataset for BMW M3 (E30 Generation), audited under DATA-16R2 strict provenance coverage standards.',
  sources: [
    {
      ...
      publishedYear: 1987,
      notes: 'Official international racing and road homologation document specifying base chassis dimensions, engine displacement (2302 cc), bore (93.4 mm), stroke (84.0 mm), 4-valve cylinder head, 5-speed manual dogleg gearbox, and aerodynamic bodywork.',
    ...
    },
    {
      ...
      tier: 'TIER_1_PRIMARY',
      title: 'BMW Group Classic — BMW M3 (E30) Factory Technical Specifications & Production Archive (1986–1991)',
      publisher: 'BMW AG / BMW Group Classic, Munich',
      referenceUrl: 'https://www.bmwgroup-classic.com',
      documentRef: 'BMW AG Historical Vehicle Documentation & Press Archives (Munich, Order Spec Ref BMW E30-M3-TECH-8691)',
      publishedYear: 2016,
    ...
    },
    {
      ...
      documentRef: 'BMW AG Corporate Registration HRB 42243 (Munich)',
