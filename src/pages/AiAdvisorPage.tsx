  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      sender: 'ai',
      text: locale === 'it' 
        ? 'Benvenuto nell’AI Strategic Advisor del settore Automotive Intelligence. Posso analizzare le tendenze di mercato d’asta, i costi di restauro, la liquidità e consigliare allocazioni di portafoglio su 300 modelli storici. Come posso assisterti oggi?'
